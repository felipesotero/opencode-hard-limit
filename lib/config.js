...
const NUMBER_KEYS = new Set(["minRemaining", "cacheTtlMs", "timeoutMs", "minRefreshIntervalMs", "rateLimitBackoffMs", "staleBlockMarginPct"]);
...
function coerce(key, value) {
  ...
  if (NUMBER_KEYS.has(key)) {
    ...
    if (key === "minRefreshIntervalMs" || key === "rateLimitBackoffMs") {
